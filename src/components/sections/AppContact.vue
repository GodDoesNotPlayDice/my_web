        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            <component
              ...
              class="group flex items-center gap-4 p-4 bg-white dark:bg-[#13131f] rounded-xl border border-slate-200 dark:border-gray-800 transition-all duration-300"
              :class="[link.href ? colorMap[link.color].hover + ' hover:-translate-x-0.5 cursor-pointer' : '']"
            >
              <div
